package optic_fusion1.shadowsembrace;

import optic_fusion1.engine.game.SimpleGame;
import optic_fusion1.shadowsembrace.component.Player;
import optic_fusion1.shadowsembrace.component.enemy.EnemyManager;

public class ShadowsEmbrace extends SimpleGame {

  private Player player;
  private static final EnemyManager ENEMY_MANAGER = new EnemyManager();
  private static final int ENEMY_CHANCE = 3;
  private int monsterCounter = 3;
  private int abbadonDamage = 40;
  private int abbadonHP = 100;
  private int asmodeusHP = 150;
  private int healLeft = 3;
  private int revive;
  private int key;
...
//    startUp();
  ...
  private void playerSetup() {
    ...
    player.setRole(getScanner().nextInt());
    System.out.println("\t------------------------------------------------");
  }
